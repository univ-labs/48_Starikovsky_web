...
# doingJustForLabs-WebProg
### Этот репозиторий создан для совместной учёбы по дисциплине Веб-программирование.
...
```sh
   git clone https://github.com/doingJustForLabs/WebProg.git
```
